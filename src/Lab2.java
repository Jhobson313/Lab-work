		...
		if (y.equalsIgnoreCase("y")) {
					...
					+ "headed dragon before! Choose your weapon.(enter slingshot or sword or bow and arrow)");
			{
				...
				System.out.println("Armed with your" + weapon
						+ "you approach the dragon. You can feel its fiery breath as you get closer. It stares at you with its __ eyes. (enter red or blue):");
				...
				System.out.println("Oh thank goodness!" + eyes
						+ "dragons are friendly. You pet it and become friends. You name the dragon" + "\t"
						+ "enter a name");
